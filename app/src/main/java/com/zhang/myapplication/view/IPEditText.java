package com.zhang.myapplication.view;
...
import com.zhang.myapplication.R;
...
public class IPEditText extends LinearLayout {
    ...
    public void setText(Context context, String iptext) {
//			if (TextUtils.isEmpty(mText1) || TextUtils.isEmpty(mText2)
//					|| TextUtils.isEmpty(mText3) || TextUtils.isEmpty(mText4)) {
//				Toast.makeText(context, "请输入合法的ip地址", Toast.LENGTH_LONG).show();
//			}
//			return mText1 + "." + mText2 + "." + mText3 + "." + mText4;
        if (!iptext.equals("")) {
            String[] strarray = iptext.split(".");
            for (int i = 0; i < strarray.length; i++) {
                Log.e("asd", strarray[i].toString());

            }
//            mFirstIP.setText(strarray[0].toString());
//            mSecondIP.setText(strarray[1].toString());
//            mThirdIP.setText(strarray[2].toString());
//            mFourthIP.setText(strarray[3].toString());
        }
    }
}